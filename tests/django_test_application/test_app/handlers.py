...
async def httpx_lifespan_manager() -> LifespanManager:
    ...
    state = {"httpx_client_from_user": httpx.AsyncClient(http2=False, verify=False)}  # noqa: S501
...
class ASGILifespanSignalHandler:
    ...
    async def startup(self, **kwargs):
        ...
        self.app_config.httpx_client = httpx.AsyncClient(http2=False, verify=False)  # noqa: S501
